...
| DemandForecast | intervalLow | Added | No | ai-demand
| DemandForecast | intervalHigh | Added | No | ai-demand
| DemandForecast | historyDays | Added | No | ai-demand
| DemandForecast | modelVersion | Added | No | ai-demand
| DemandForecast | dataStart | Added | No | ai-demand
| DemandForecast | dataEnd | Added | No | ai-demand
| DemandForecast | onHand | Added | No | ai-demand
| DemandForecast | availableToPromise | Added | No | ai-demand
| DemandForecast | minStock | Added | No | ai-demand
| DemandForecast | reorderQty | Added | No | ai-demand
| DemandForecast | stockGap | Added | No | ai-demand
| DemandForecast | forecastMethod | Added | No | ai-demand

|=======================================================

=== Migration Scripts
1.  Migration service *migratePersonMaritalStatusType* is implemented to migrate the
    *oldMaritalStatusEnumId* field to *maritalStatusTypeId* on entity *Person*. +
    (More detail at https://issues.apache.org/jira/browse/OFBIZ-13329[OFBIZ-13329])
2.  Migration service *upgradeDemandForecastDefaults* is implemented to backfill new
    fields on entity *DemandForecast* (intervals, stock metadata, method).
